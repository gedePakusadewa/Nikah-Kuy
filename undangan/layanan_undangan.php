            ...
            <?php
              if(isset($_SESSION['user'])){
                echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']."</a>
                    <a href=\"layanan_undangan.php?out='1'\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
              }else{
            ...
            <?php
              if(isset($_SESSION['user'])){
                  echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right \">".$_SESSION['user']."</a>
                      <a href=\"layanan_undangan.php?out='1'\" class=\"w3-bar-item w3-button \">Log Out</a>";
              }else{
                  echo"<a onclick=\"login()\" 
      ...
      ?>
        ...
        <div class="w3-container w3-padding-32" id="projects">
          <h3 class="w3-border-bottom w3-center w3-border-light-grey 
            w3-padding-16">Vendor Kartu Undangan Di Surabaya</h3>
        </div>
        ...
        <div class="w3-row-padding">
          ...
          <?php
              if(isset($_SESSION['daftar_undangan'])){
                  foreach($_SESSION['daftar_undangan'] as $info_item){
                      echo 
                      "<div class=\"w3-col l3 m6 w3-margin-bottom\">
                        <div class=\"w3-display-container w3-border\">
                          <img src=\"../".$info_item['path_gambar']."\" alt=\"undangan\" style=\"width:100%\">
                          <div class=\"w3-padding\">
                            ...
                            <div class=\"w3-center w3-padding-16\">
                                <a href=\"layanan_undangan.php?input_undangan=".$info_item['id']."\" class=\"w3-button w3-black\" style=\"width:65%;\" >Masukan</a>
                            </div>
