<?php
  ...
  if (isset($_GET['out'])) {
      unset($_SESSION['user']);
      header("Location: layanan_honeymoon.php");
      exit();
  }
          ...
          <?php
            if(isset($_SESSION['user'])){
              echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']."</a>
                  <a href=\"layanan_honeymoon.php?out='1'\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
            }else{
          ...
          <?php
            if(isset($_SESSION['user'])){
                echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right \">".$_SESSION['user']."</a>
                    <a href=\"layanan_honeymoon.php?out='1'\" class=\"w3-bar-item w3-button \">Log Out</a>";
            }else{
                echo"<a onclick=\"login()\" 
