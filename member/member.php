            ...
            <?php
                if(isset($_SESSION['user'])){
                    echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']."</a>
                        <a href=\"member.php?out='1'\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
                }else{
            ...
            <?php
                if(isset($_SESSION['user'])){
                    echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right \">".$_SESSION['user']."</a>
                        <a href=\"member.php?out='1'\" class=\"w3-bar-item w3-button \">Log Out</a>";
                }else{
                    echo"<a onclick=\"login()\" 
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
      ...
      <div id="checkout_modal" class="w3-modal">
        <div class="w3-modal-content w3-animate-top w3-card-4">
            ...
            <div class="w3-container w3-padding">
              <?php echo checkoutFinal();?>
              <p>Total Pembayaran Awal adalah Rp. <?php echo"".$_SESSION['harga_checkOut']; ?>,-</p>
              <p>Silahkan melakukan pembayaran, transaksi dapat dilakukan melalui ATM, Credit Card, Go Pay</p>
            </div>
            <footer class="w3-container w3-black">
