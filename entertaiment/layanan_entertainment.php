<?php
  ...
  if (isset($_GET['out'])) {
    unset($_SESSION['user']);
    header("Location: layanan_entertainment.php");
    exit();
  }
...
<html> 
        ...
        <div class="w3-right">
            ...
            <?php
                ...
                echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']."</a>
                    <a href=\"layanan_entertainment.php?out='1'\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
                }else{
          ...
          <?php
            if(isset($_SESSION['user'])){
                echo "<a href=\"../member/member.php\" class=\"w3-bar-item w3-button w3-border-right \">".$_SESSION['user']."</a>
                    <a href=\"layanan_entertainment.php?out='1'\" class=\"w3-bar-item w3-button \">Log Out</a>";
            }else{
                echo"<a onclick=\"login()\" 
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
      ...
      <div class="w3-container w3-padding-32" id="projects">
        <h3 class="w3-border-bottom w3-center w3-border-light-grey w3-padding-16">Vendor Wedding Entertainer Di Surabaya</h3>
      </div>
